...
from auth.containers.partials.command_handlers import CommandHandlersContainer
from auth.containers.partials.domain_event_handlers import DomainEventHandlersContainer
